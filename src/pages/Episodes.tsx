...
const Episodes = () => {
  ...
  const links: string[] = [
    'https://www.youtube.com/embed/-uLTrI4tqmE?si=WGzH1Jq8ys89Eghg',
    'https://www.youtube.com/embed/RsMBeBiBph0?si=aLoqSGmZG2pr5YzX', 
    'https://www.youtube.com/embed/U0AbAfKEGXM?si=ug2ILeU9ojdh_RvA', 
    'https://www.youtube.com/embed/bgs0acrZXBg?si=NNO3c32meId4t8oy',
  ];
    ...
    <div className="relative space-y-14 px-16 blog:px-10">
      <div className="relative flex blog:flex-col blog:space-x-0 items-center justify-between space-x-16 h-full pt-12">
        <div className="flex-1 space-y-4 blog:text-center">
          <h1 className="text-6xl blog:text-2xl italic font-medium">Women in Egypt- Menna Khalil</h1>
          <p className="text-[#B8B8B8]">Watch our latest episode.</p>
          <a href="https://youtu.be/-uLTrI4tqmE?si=QW8J3EJiD30VFra-" target="_blank" className="blog:hidden mt-4 rounded-md py-2.5 inline-block px-6 border-2 text-primary border-primary hover:text-[#F5F5F5] hover:bg-primary transition-all duration-200">Watch Now</a>
        </div>
